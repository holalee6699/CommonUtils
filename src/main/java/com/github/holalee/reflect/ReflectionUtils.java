package com.github.holalee.reflect;

import com.github.holalee.common.Tools;
...
public class ReflectionUtils {
     ...
     * exception or LongwanController of its superclasses, which means that an exception of
		...
		if (result == null) {
			try {
				...
				throw new IllegalStateException(
						"Failed to introspect Class [" + clazz.getName() + "] from ClassLoader [" + clazz.getClassLoader() + "]", ex);
			}
		}
		return result;
	}
